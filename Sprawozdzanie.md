...
|NIP|varchar(255)|NIP firmy/null |
- kod DDL
...
|Oplata|numeric(10,2)|Opłata za usługi * liczba uczestników|
...
Nazwa tabeli: Historia_Rezerwacji
- Opis: (opis tabeli, komentarz)

| Nazwa atrybutu | Typ | Opis/Uwagi |
| -------------- | --- | ---------- |
| ID_Hist |  int   |    Klucz główny, niepowtarzalny, który się inkrementuje automatycznie        |
|Oplata|numeric(10,2)|Opłata za usługi * liczba uczestników|
|Data_Rezerwacji|datetime|Data dokonania rezerwacji|
|ID_Uslugi|int|Klucz obcy id uslugi z tabeli Uslugi|
|ID_Wycieczki|int|Klucz obcy id wycieczki z tabeli Wycieczki|
|ID_Klienta |int|Klucz obcy id klienta z tabeli Klienci|
|ID_Oplaty |int|Klucz obcy id opłaty z tabeli Oplaty|
- kod DDL
...
FOREIGN KEY (ID_Wycieczki) REFERENCES Wycieczki(ID_Wycieczki),
FOREIGN KEY (ID_Klienta) REFERENCES Klienci(ID_Klienta),
FOREIGN KEY (ID_Oplaty) REFERENCES Oplaty(ID_Oplaty)
)
